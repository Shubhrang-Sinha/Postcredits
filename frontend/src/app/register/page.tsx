      ...
      <div className="relative w-full max-w-md">
        <div className="bg-[#261d1d]/80 backdrop-blur-xl rounded-2xl border border-[#3d4a3d]/30 p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-black tracking-tight text-white mb-2">Postcredits</h1>
            <p className="text-[#bccbb9] text-sm">Create your account</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-[#bccbb9] text-sm">
              ...
              <Link href="/login" className="text-[#53e076] font-bold hover:underline">
                Login
              </Link>
            </p>
          </div>
